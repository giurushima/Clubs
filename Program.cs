...
{
    setupAction.AddSecurityDefinition("ClubsBearerAuth", new Microsoft.OpenApi.Models.OpenApiSecurityScheme() //Esto va a permitir usar swagger con el token.
    {
    ...
    {
        {
            new OpenApiSecurityScheme
            {
                Reference = new OpenApiReference
                {
                    ...
                    Id = "ClubsBearerAuth" } //Tiene que coincidir con el id seteado arriba en la definición
                }, new List<string>() }
    });
});

builder.Services.AddSingleton<ClubsContext>();
